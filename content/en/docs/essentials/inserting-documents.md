...
It is also possible to omit the list of fields and use a [document literal]({{< relref "/docs/essentials/expressions" >}}#documents):
...
The conversion compatible table can be found in the [data types]({{< relref "/docs/essentials/data-types" >}}#explicit-conversion) page.
